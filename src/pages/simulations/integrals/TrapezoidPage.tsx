...
import init, { integral_trapezoid } from "../../../../simulation-engine/pkg/simulation_engine";
...
function TrapezoidPage() {
    ...
    const handleRunSimulation = () => {
        ...
        try {
            ...
            console.log(ready);
            const value = integral_trapezoid(ready, A, B, N);
    ...
    return (
        <SimulationsContainer children={
            <>
                <h3>Trapezoid method for numerical integrals</h3>
