...
import init, { solve_aitken } from "../../../../simulation-engine/pkg/simulation_engine";

export function AitkenPage() {
    ...
    const handleRunSimulation = () => {
        ...
        try {
            ...
            console.log(ready);
            const value = solve_aitken(ready, A, 10 ** (-tolerance));
